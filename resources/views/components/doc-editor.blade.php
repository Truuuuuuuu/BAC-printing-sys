                            ...
                            <div class="space-y-3 max-h-72 overflow-y-auto pr-1">
                                <template x-for="(row, rowIndex) in tableRows[group]" :key="rowIndex">
                                    <div class="border border-gray-100 rounded-lg p-2 bg-gray-50 relative">
                                        <button type="button"
                                                @click="removeTableRow(group, rowIndex)"
                                        ...
                                        <template x-for="[field, fieldCfg] in Object.entries(groupCfg.fields)" :key="field">
                                            <div class="mb-1.5">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm sticky top-6">
                <div class="flex items-center gap-2 px-4 py-3 border-b border-gray-100">
                    ...
                    <span class="ml-auto flex items-center gap-2">
                        <svg x-show="previewing" class="w-3.5 h-3.5 animate-spin text-blue-500"
