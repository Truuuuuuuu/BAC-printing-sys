...
<div>
    <div class="border rounded-2xl p-5 space-y-3 bg-foreground">
        <div class="inline-block bg-blue-100 text-primary rounded-xl px-2 ">
        ...
        <button class="relative w-full bg-bg-green hover:bg-primary hover:scale-105 text-foreground font-semibold rounded-3xl py-1 hover:shadow-md transition-all duration-200"
