<div x-show="showDeleteModal" x-cloak class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-3">
    <div class="bg-white rounded-2xl p-6 w-full max-w-md">
        ...
        <div class="flex gap-3 mt-8 justify-end">
            <button @click="showDeleteModal = false" class="px-4 py-1 hover:border rounded-xl">Cancel</button>
